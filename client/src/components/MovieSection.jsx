    ...
    return (
        <div className = 'px-6 md:px-16 lg:px-24 xl:px-44 overflow-hidden'>
            <div className = 'relative flex items-center justify-between pt-20'>
                <p className = 'text-white font-medium text-2xl'>Movies</p>
                <button onClick = { () => navigate('/movies') } className = 'group flex items-center gap-2 text-md text-gray-300 cursor-pointer'>
            ...
            {isLoading ? (
                ...
                movies.length > 0 ? (
                    ...
                    <p className = 'text-gray-400 mt-3'>No movies avaiable</p>
                )
            )}
        </div>
    );
