    ...
    return (
         <div className = 'px-6 md:px-16 lg:px-24 xl:px-44 overflow-hidden mt-'>
            <div className = 'relative flex items-center justify-between pt-20'>
                <p className = 'text-white font-medium text-xl'>Tv Series</p>
                ...
                series.length > 0 ? (
                    <>
                        ...
                        <div className = 'flex justify-center mt-10'>
                            <button onClick = { () => {navigate('/series'); scrollTo(0, 0);} } className = 'px-10 py-3 text-sm bg-primary hover:bg-primary-dull transition rounded-md font-medium cursor-pointer'>Show more</button>
                        </div>
                    </>
                ) : (
                    <p className = 'text-gray-400'>No tv series avaiable</p>
                )
            )}
        </div>
    );
